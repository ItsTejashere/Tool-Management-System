...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2026 at 08:52 AM
...
CREATE TABLE `tool` (
  ...
  `status` enum('AVAILABLE','IN_USE','SHARPENING','DAMAGED') DEFAULT 'AVAILABLE',
...
CREATE TABLE `users` (
  ...
  `role` enum('INVENTORY','MANAGER') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'inventory', 'inventory123', 'INVENTORY'),
...
--
ALTER TABLE `tool`
  MODIFY `tool_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tool_movement`
  MODIFY `movement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
